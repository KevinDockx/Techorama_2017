...
{ 
    ...
    public class SongsController : Controller
    {
        ...
        [HttpGet(Name = "GetSongsFromPlaylist")]
        public IActionResult GetSongsForPlaylist(Guid playlistId)
        {
        ...
        public IActionResult GetSongFromPlaylist(Guid playlistId, Guid songId)
        {
            ...
            return Ok(Mapper.Map<Models.Song>(song));
        }

        [HttpPost(Name = "AddSongToPlaylist")]
